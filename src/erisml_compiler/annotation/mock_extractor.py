...
def _medical_confidentiality() -> ExtractorResult:
    stakeholders = [
        ...
        Stakeholder(
            id="threatened_party",
            label="Identifiable third party at risk",
            type="individual",
    ...
    events = [
        Event(
            id="evt_001",
            time_index=0,
            type="confidentiality_established",
            actor="doctor",
            target="patient",
        ...
        Event(
            id="evt_002",
            time_index=1,
            type="threat_disclosed",
            actor="patient",
            target="threatened_party",
...
def _whistleblower() -> ExtractorResult:
    ...
    commitments = [
        Commitment(
            ...
            defeasibility_conditions=[
                "vow_to_commit_wrong",
                "catastrophic_nonconsensual_externality",
            ],
            source_spans=["seg_001:0-80"],
        ),
    ]
